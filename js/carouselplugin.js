  ...
  $.fn.carouselplugin = function(options){
    ...
    init = function () { 
      ...
      if (settings.keyboardNavigation) {
        // must use keydown, not keypress for targeting non-output keyboard keys (such as arrows)
        $(document).keydown(function (e) {
          switch(e.keyCode) {
            case 37: // keycode 37 is the left arrow
              previous();
              break;
            case 39: // keycode 39 is the right arrow
              next();
              break;
            default:
              return false;
